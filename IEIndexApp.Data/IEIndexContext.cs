...
namespace IEIndexApp.Data.Contexts
{
    public class IEIndexContext : DbContext
    {
        ...
        protected IEIndexContext(DbContextOptions options) : base(options)
        {
        ...
        {          
            ...
            modelBuilder.Entity<Author>().HasMany(x => x.Articles);           
            ...
            modelBuilder.Entity<Subject>().HasMany(x => x.Articles);
        }
    }
}
